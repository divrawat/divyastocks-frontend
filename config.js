...
export const IMAGES_DOMAIN = "https://images.divyastocks.online"
...
// Navbar
export const logo = <img src="/logo.webp" alt="Logo" className="h-[40px] w-[45px] mr-5 md:ml-0 ml-4 md:my-0 my-1 rounded-full" />
...
export const navLinks = [
  { text: 'Stocks', href: '/categories/stocks' },
  { text: 'Markets', href: '/categories/markets' },
  { text: 'IPO', href: '/categories/ipo' },
  { text: 'Crypto', href: '/categories/crypto' },
];
