...
import { updateAllToDraft, updateAllToPublish } from "@/actions/story";
...
const WebStoryBulk = () => {
    ...
    return (
        <AdminDashboard>
            ...
            <h2 className="3xl font-bold text-center mb-5">Convert All Web Stories To Draft</h2>
            ...
            <h2 className="3xl font-bold text-center mb-5 mt-[120px]">Convert All Web Stories To Publish</h2>
            <div className="flex justify-center">
            ...
            <div className={`fixed inset-0 flex items-center justify-center z-50 md:pl-[150px]  ${isOpen ? '' : 'hidden'}`}>
                ...
                <div className="bg-white p-8 rounded-lg shadow-lg z-10">
                    ...
                    <p className="mb-4">Type: <span className="font-bold">I want to update all Web Stories to draft</span></p>
                    ...
                    <div className="flex justify-end mt-8">
                        <button onClick={() => confirmdraft()}
                            className={`text-sm bg-[#ca0a0a] mr-2 hover:bg-[#0A4158] hover:scale-105 active:scale-95 transition-transform text-white font-semibold py-2 px-4 rounded ${inputValue !== 'I want to update all Web Stories to draft' ? 'opacity-50 cursor-not-allowed' : ''}`}
            ...
            <div className={`fixed inset-0 flex items-center justify-center z-50 md:pl-[150px]  ${isOpen0 ? '' : 'hidden'}`}>
                ...
                <div className="bg-white p-8 rounded-lg shadow-lg z-10">
                    ...
                    <p className="mb-4">Type: <span className="font-bold">I want to update all Web Stories to publish</span></p>
                    ...
                    <div className="flex justify-end mt-8">
                        <button onClick={() => confirmdraft0()}
                            className={`text-sm bg-[#ca0a0a] mr-2 hover:bg-[#0A4158] hover:scale-105 active:scale-95 transition-transform text-white font-semibold py-2 px-4 rounded ${inputValue !== 'I want to update all Web Stories to publish' ? 'opacity-50 cursor-not-allowed' : ''}`}
